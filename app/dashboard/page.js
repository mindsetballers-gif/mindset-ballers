  ...
  return (
    <div className="min-h-screen bg-black text-green-400 flex flex-col items-center justify-center p-6">
      ...
      <p className="text-xl max-w-3xl text-center mb-10 text-white leading-relaxed">
        ...
        la que muy pocos logran acceder. Aquí encontrarás conocimiento exclusivo,
        pruebas de mentalidad deportiva y un entorno en el que descubriremos si
        realmente estás preparado para pertenecer a esta élite.
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 w-full max-w-6xl">
        ...
        <div className="border-2 border-green-500 rounded-2xl p-6 text-center shadow-lg transition transform hover:scale-105 hover:shadow-green-500/80 hover:bg-green-500/10">
          ...
          <p className="mt-2 text-sm text-white">
            Contenido exclusivo para trabajar tu mentalidad deportiva. Aprende a
            conocerte, gestionar la presión y responder en momentos clave.
          </p>
        </div>
